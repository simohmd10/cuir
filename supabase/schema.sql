...
INSERT INTO categories (name, name_ar, slug, image) VALUES
  ('Sacs à Main',   'حقائب اليد',     'sacs-a-main',   NULL),
  ('Sacs de Voyage','حقائب السفر',    'sacs-voyage',   NULL),
  ('Portefeuilles', 'المحافظ',        'portefeuilles', NULL),
  ('Ceintures',     'الأحزمة',        'ceintures',     NULL),
  ('Accessoires',   'الإكسسوارات',   'accessoires',   NULL)
